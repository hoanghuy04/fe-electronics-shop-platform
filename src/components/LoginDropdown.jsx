            ...
            {isVisible && (
                ...
                >
                    ...
                    <div className="pb-4 px-4 flex gap-2">
                        <Link to={path.login} onClick={handleButtonClick} className="flex-1">
                            <Button
                                type="primary"
                                block
                        ...
                        <Link to={path.register} onClick={handleButtonClick} className="flex-1">
                            <Button
                                block
                    ...
                    <div className="p-4 border-t border-gray-200">
                        <Link to="/help" className="flex items-center text-sm text-gray-600" onClick={handleButtonClick}>
