...
const ProductDetail = () => {
  ...
  useEffect(() => {
    ...
    if (foundProduct) {
      ...
      // Giả lập hình ảnh chính (thay bằng URL thực tế nếu có)
  ...
  const relevantProducts = productsData.filter((productFilter) => {
    const keyword = product.title.split(" ")[0].toUpperCase();
    return productFilter.title.toLocaleUpperCase().includes(keyword) && productFilter._id.$oid !== product._id.$oid;
  });
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 rounded-lg shadow-lg bg-white py-4  px-8">
        ...
        <div>
          ...
          <div className="flex items-center mt-2">
            ...
            <a href='/' className="ml-2 text-gray-500">Xem đánh giá</a>
          </div>
          ...
          {/* Khuyến mãi */}
          <div className="mt-5">
            <a href='/cart' className="bg-blue-500 text-white px-4 py-3 rounded-md">
            ...
            <div className="mt-10 text-gray-700">
              ...
              <p className='font-bold text-blue-500'>
                Hỗ trợ trả góp MPOS (thẻ tín dụng), HDSAISON (<a href='/' className='text-red-600'>Xem chi tiết</a>).
              </p>
            </div>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="border-b border-gray-200 pb-4">
              ...
              <p className="text-gray-600 mt-1">
                Sản phẩm rất tốt, sử dụng mượt mà, đáng giá với số tiền bỏ ra!
              </p>
              <span className="text-gray-500 text-sm">Đăng ngày 01/04/2025</span>
            </div>
            {/* Bình luận 2 */}
            <div className="border-b border-gray-200 pb-4">
              <div className="flex items-center">
              ...
              <p className="text-gray-600 mt-1">
                Hài lòng, nhưng giao hàng hơi chậm. Cần cải thiện tốc độ giao hàng.
              </p>
              <span className="text-gray-500 text-sm">Đăng ngày 02/04/2025</span>
            </div>
          </div>
          {/* Nút xem thêm */}
          <div className="mt-4">
      ...
      <div className="mt-6 rounded-lg shadow-lg bg-white py-4  px-8">
        ...
        >
          {relevantProducts.map((relevantProduct) => {
            return <ProductCard key={relevantProduct._id.$oid} product={relevantProduct} />
          })}
        </Carousel>
      </div>
    </div>
